...
4. **Reproducibility:** prefer commands and committed config files (`wrangler.jsonc`, `render.yaml`, `.github/workflows/`) over manual dashboard settings, so the setup survives a fresh clone.
